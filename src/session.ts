...
import {
    ...
    PageEventObject,
    Options,
    ValidMediaAttributeKeys,import { MediaEvent } from './events';
    import {
        AdBreak,
        AdContent,
        MediaContentType,
    ...
    export class MediaSession {
         ...
         * @param baseCustomAttributes A set of base custom attributes to attach to all media events
         */
        constructor(
         ...
         *     baseCustomAttributes = {}          //optional defaults to empty object
         * );
         *
